...
# Create fourth plot - 2x2 plots with Global Active Power, Voltage, Energy sub metering and Global reactive power for thurs, fri, sat #
png(file="C:/Users/tywhalen/Downloads/plot4.png", width=480, height=480)

par(mfrow=c(2, 2))

plot(date_time, tidy_data$Global_active_power, type="l", xlab="", ylab="Global Active Power")

plot(date_time, tidy_data$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col=c("black", "red", "blue"), lwd=2, lty=1, cex=0.8)

plot(date_time, tidy_data$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
