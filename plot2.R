...
# Create second plot - global active power for thurs, fri, sat #
png(file="C:/Users/tywhalen/Downloads/plot2.png", width=480, height=480)

plot(date_time, tidy_data$Global_active_power, type="l", ylab="Global Active Power (kilowatts)", xlab="")
